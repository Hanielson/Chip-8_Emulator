...
class Chip8{
    ...
    private:
        const double TARGET_IPS = 720.0;
        const double TIME_PER_INSTRUCTION = 1.0 / TARGET_IPS;
        const Uint64 COUNTS_PER_INSTRUCTION = (Uint64)(TIME_PER_INSTRUCTION * SDL_GetPerformanceFrequency());
